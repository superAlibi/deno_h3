export const SUCCESS_STATUSES = [200, 201, 202, 203, 204, 205, 206, 207, 208, 226] as const;
...
export const NO_BODY_METHODS = ["get", "head", "options", "trace", "connect"] as const;
...
export function getEndpointList(host: string) {
  ...
  return {
    ...
    docs: [
      { framework: "hono", url: `http://localhost:${SERVER_PORTS.hono}/docs` },
    ],
  };
}
